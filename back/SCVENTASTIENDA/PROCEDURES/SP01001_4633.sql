--------------------------------------------------------
--  DDL for Procedure SP01001_4633
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "SCVENTASTIENDA"."SP01001_4633" 
...
Descripcion: Recibe el registro 4633 en texto separados por comas, 
             actualiza la tabla TAPEDIDOS (FNPEDTOTAL y FNPEDSALDO)
...
BEGIN
   ...
   MERGE INTO SCVENTASTIENDA.TAPEDIDOS DATOS
       USING (SELECT pa_FiPaisId PAIS, 
                     pa_FiCanalId CANAL, 
                     pa_FiSucursalId  SUC, 
                     recTAEST01001_4633.FINOPEDIDO PEDIDO
                FROM DUAL) VALORES
        ...
        WHEN MATCHED THEN
             UPDATE
                SET  FNPEDTOTAL = recTAEST01001_4633.FNPEDTOTAL,
                     FNPEDSALDO = recTAEST01001_4633.FNPEDSALDO;
   ...
   MERGE INTO SCVENTASTIENDA.TACREDITO DATOS
       USING (SELECT pa_FiPaisId PAIS, 
        ...
        WHEN MATCHED THEN
             UPDATE
                SET  FNPEDULTPAGO = recTAEST01001_4633.FNPEDULTPAGO,
                     FDVENCIMIENTO = recTAEST01001_4633.FDVENCIMIENTO,
                     FIPLAZO = recTAEST01001_4633.FIPLAZO;
EXCEPTION
   WHEN OTHERS THEN
...
/
  ...
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_4633" TO "USRVENTAST";
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_4633" TO "SCACTUALIZADORVT";
