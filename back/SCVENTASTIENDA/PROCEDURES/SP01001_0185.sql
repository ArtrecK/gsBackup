--------------------------------------------------------
--  DDL for Procedure SP01001_0185
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "SCVENTASTIENDA"."SP01001_0185" 
...
Descripcion: Recibe el registro 185 en texto separados por comas, 
             actualiza la tabla TAPEDIDOS (FCEMPNOSURTE, FIPEDSTAT, FDPEDFEC y FDFECSURT)
...
BEGIN
   ...
   MERGE INTO SCVENTASTIENDA.TAPEDIDOS DATOS
       USING (SELECT pa_FiPaisId PAIS, 
                     pa_FiCanalId CANAL, 
                     pa_FiSucursalId  SUC, 
                     recTAEST01001_0185.FINOPEDIDO PEDIDO 
                FROM DUAL) VALORES
        ...
        WHEN MATCHED THEN
             UPDATE
                SET  FCEMPNOSURTE = trim(recTAEST01001_0185.FCUSERSURTE),
                     FIPEDSTAT = recTAEST01001_0185.FIPEDSTAT,
                     FDPEDFEC = recTAEST01001_0185.FDPEDFEC,
                     FDFECSURT = recTAEST01001_0185.FDFECSURT;
...
/
  ...
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_0185" TO "USRVENTAST";
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_0185" TO "SCACTUALIZADORVT";
