--------------------------------------------------------
--  DDL for Procedure SP01001_0010
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "SCVENTASTIENDA"."SP01001_0010" 
...
Descripcion: Recibe el registro 10 en texto separados por comas, 
             inserta en la tabla TACLIENTES
...
***************************************************************************************************/
   ...
   csl_recTAEST01001_0010    SCVENTASTIENDA.TAEST01001_0010%ROWTYPE := NULL;
   csl_ValorCero          NUMBER(1) := 0;
   vl_pa_Query2           VARCHAR2(3000) := '';

BEGIN
   pa_ErrMsg := 'TAEST01001_0010';

   SELECT REPLACE(UPPER(pa_Query),'FROM DUAL',', SYSDATE, SYSDATE, USER FROM DUAL') INTO vl_pa_Query2 from dual;

   EXECUTE IMMEDIATE vl_pa_Query2 INTO csl_recTAEST01001_0010;
   ...
   MERGE INTO SCVENTASTIENDA.TACLIENTES DATOS
      USING (SELECT pa_FiPaisId AS PAIS,
                    ...
                    csl_recTAEST01001_0010.FINGCIOID AS NGCIOID, 
                    csl_recTAEST01001_0010.FINOTIENDA AS NOTIENDA, 
                    csl_recTAEST01001_0010.FICTEID AS CTEID, 
                    csl_recTAEST01001_0010.FIDIGITOVER AS DIGITOVER
               FROM DUAL) VALORES
   ...
   WHEN MATCHED THEN
      UPDATE 
         SET FIOCUID = csl_recTAEST01001_0010.FIOCUID,
             FCCTENOMBRE = csl_recTAEST01001_0010.FCCTENOMBRE,
             FCCTEAPATERNO = csl_recTAEST01001_0010.FCCTEAPATERNO,
             FCCTEAMATERNO = csl_recTAEST01001_0010.FCCTEAMATERNO,
             FCCTEDIRCALLE = csl_recTAEST01001_0010.FCCTEDIRCALLE,
             FCCTEDIRNOEXT = csl_recTAEST01001_0010.FCCTEDIRNOEXT,
             FCCTEDIRNOINT = csl_recTAEST01001_0010.FCCTEDIRNOINT,
             FCCTECP = csl_recTAEST01001_0010.FCCTECP,
             FCCTECOLONIA = csl_recTAEST01001_0010.FCCTECOLONIA,
   ...
   WHEN NOT MATCHED THEN
      ...
      VALUES ( 
              ...
              pa_FiCanalId,
              pa_FiSucursalId,     
              csl_recTAEST01001_0010.FINGCIOID, 
              csl_recTAEST01001_0010.FINOTIENDA, 
              csl_recTAEST01001_0010.FICTEID, 
              csl_recTAEST01001_0010.FIDIGITOVER, 
              csl_recTAEST01001_0010.FIOCUID, 
              csl_recTAEST01001_0010.FCCTENOMBRE, 
              csl_recTAEST01001_0010.FCCTEAPATERNO, 
              csl_recTAEST01001_0010.FCCTEAMATERNO, 
              csl_recTAEST01001_0010.FCCTEDIRCALLE, 
              csl_recTAEST01001_0010.FCCTEDIRNOEXT, 
              csl_recTAEST01001_0010.FCCTEDIRNOINT, 
              csl_recTAEST01001_0010.FCCTECP, 
              csl_recTAEST01001_0010.FCCTECOLONIA,
              SYSDATE,
              pa_FiTranno
             );
...
/
  ...
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_0010" TO "USRVENTAST";
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_0010" TO "SCACTUALIZADORVT";
