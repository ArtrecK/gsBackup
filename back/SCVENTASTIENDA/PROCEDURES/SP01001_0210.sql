--------------------------------------------------------
--  DDL for Procedure SP01001_0210
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "SCVENTASTIENDA"."SP01001_0210" 
...
Descripcion: Recibe el registro 210 en texto separados por comas, 
             actualiza la tabla TAPEDIDOS (FDFECSURT y FIPEDFACT)
...
BEGIN
   ...
   MERGE INTO SCVENTASTIENDA.TAPEDIDOS DATOS
       USING (SELECT pa_FiPaisId PAIS, 
                     pa_FiCanalId CANAL, 
                     pa_FiSucursalId  SUC, 
                     recTAEST01001_0210.FINOPEDIDO PEDIDO                     
                FROM DUAL) VALORES
        ...
        WHEN MATCHED THEN
             UPDATE
                SET  FDFECSURT = recTAEST01001_0210.FDFECSURT,
                     FIPEDFACT = recTAEST01001_0210.FIPEDFACT;


   pa_ErrMsg := 'UPDATE SCVENTASTIENDA.TACREDITO';
   MERGE INTO SCVENTASTIENDA.TACREDITO DATOS
       USING (SELECT pa_FiPaisId PAIS, 
        ...
        WHEN MATCHED THEN
             UPDATE
                SET  FDINIPERIODO = recTAEST01001_0210.FDINIPERIODO,
                     FNPEDPAGOPER = recTAEST01001_0210.FIPEDFACT,
                     FDVENCIMIENTO = recTAEST01001_0210.FDVENCIMIENTO,
                     FNPEDULTPAGO = recTAEST01001_0210.FNPEDULTPAGO;
...
/
  ...
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_0210" TO "USRVENTAST";
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_0210" TO "SCACTUALIZADORVT";
