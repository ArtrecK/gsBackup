...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE "SCSISGES"."PATYPES" 
IS
/*************************************************************
...
/
  ...
  GRANT EXECUTE ON "SCSISGES"."PATYPES" TO "SCVENTASTIENDA";
  GRANT EXECUTE ON "SCSISGES"."PATYPES" TO "USRSISGES";
  GRANT EXECUTE ON "SCSISGES"."PATYPES" TO "USRVENTAST";
