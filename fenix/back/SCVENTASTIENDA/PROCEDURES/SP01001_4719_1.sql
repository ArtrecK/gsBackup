--------------------------------------------------------
--  DDL for Procedure SP01001_4719
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "SCVENTASTIENDA"."SP01001_4719" 
...
Descripcion: Recibe el registro 4719 en texto separados por comas, 
             actualiza la tabla TAPEDIDOS (FCEMPNOSURTE)
...
BEGIN
   ...
   MERGE INTO SCVENTASTIENDA.TAPEDIDOS DATOS
       USING (SELECT pa_FiPaisId PAIS, 
                     pa_FiCanalId CANAL, 
                     pa_FiSucursalId  SUC, 
                     recTAEST01001_4719.FINOPEDIDO PEDIDO
                FROM DUAL) VALORES
        ...
        WHEN MATCHED THEN
             UPDATE
                SET  FCEMPNOSURTE = TRIM(recTAEST01001_4719.FCEMPSURTIO);
...
/
  ...
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_4719" TO "USRVENTAST";
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_4719" TO "SCACTUALIZADORVT";
