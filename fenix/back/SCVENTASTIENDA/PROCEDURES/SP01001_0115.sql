--------------------------------------------------------
--  DDL for Procedure SP01001_0115
--------------------------------------------------------
set define off;

  CREATE OR REPLACE EDITIONABLE PROCEDURE "SCVENTASTIENDA"."SP01001_0115" 
...
Descripcion: Recibe el registro 115 en texto separados por comas, 
             actualiza la tabla TAPEDIDOS (FNPEDTOTAL, FNPEDSALDO y FNENGANCHE)
...
BEGIN
   ...
   MERGE INTO SCVENTASTIENDA.TAPEDIDOS DATOS
       USING (SELECT pa_FiPaisId PAIS, 
                     pa_FiCanalId CANAL, 
                     pa_FiSucursalId  SUC, 
                     recTAEST01001_0115.FINOPEDIDO PEDIDO                     
                FROM DUAL) VALORES
        ...
        WHEN MATCHED THEN
             UPDATE
                SET  FNPEDTOTAL = recTAEST01001_0115.FNPEDTOTAL,
                     FNPEDSALDO = recTAEST01001_0115.FNPEDSALDO,
                     FNENGANCHE = recTAEST01001_0115.FNENGANCHE;
   ...
   MERGE INTO SCVENTASTIENDA.TACREDITO DATOS
       USING (SELECT pa_FiPaisId PAIS, 
        ...
        WHEN MATCHED THEN
             UPDATE
                SET  FNENGANCHE = recTAEST01001_0115.FNENGANCHE;
...
/
  ...
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_0115" TO "USRVENTAST";
  GRANT EXECUTE ON "SCVENTASTIENDA"."SP01001_0115" TO "SCACTUALIZADORVT";
